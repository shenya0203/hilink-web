...
export default {
    ...
    common: {
        ...
        loadingRetry: 'Load failed, retrying ({n}/{total})…',
    ...
    login: {
        ...
        deviceUnreachable: 'Cannot reach the device. Check the network or device status, then sign in again'
    },
    ...
    dtu: {
        title: 'Serial DTU',
        description: 'Transparent serial-to-network via DTU Socket / HTTP / MQTT. Configure everything on this page, separate from Edge channels.',
        enable: 'DTU Enable',
        workMode: 'Work Mode',
        modeNet: 'Network (NET)',
        modeHttp: 'HTTP',
        ...
        sockSection: 'DTU Socket',
        topicSection: 'Transparent Topics',
        uartBind: 'Bind UART',
        packLen: 'Pack Length (bytes)',
        packTime: 'Pack Time (ms)',
        sockBind: 'Bind Socket',
        mqttBind: 'Bind MQTT',
        sockHint: 'DTU-dedicated Socket (stored in /etc/config/dtu_tunnel), unrelated to sidebar Edge Socket.',
        httpHint: 'HTTP mode uses the DTU Socket; work mode is set to HTTP Client automatically.',
        mqttConnHint: 'DTU-dedicated MQTT (stored in /etc/config/dtu_tunnel), unrelated to sidebar Edge MQTT. Transparent topics are per UART.',
        fixedChannelUart1: 'This channel is fixed to dtu_tunnel.SOCK_DTU0 / MQTT_DTU0.',
        fixedChannelUart2: 'This channel is fixed to dtu_tunnel.SOCK_DTU1 / MQTT_DTU1.',
        ...
        sockDisabled: 'Enable the DTU Socket first',
        mqttDisabled: 'Enable MQTT for this channel first',
        httpModeRequired: 'HTTP mode requires the DTU Socket to be HTTP Client',
        netModeConflict: 'NET mode cannot use HTTP Client mode',
