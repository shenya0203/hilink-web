...
export default {
    ...
    edge: {
        ...
        targetChannel: '目标通道',
        enableStatus: '启用状态',
        addPassthroughRule: '添加透传规则',
        editPassthroughRule: '编辑透传规则',
        idleTime: '空闲断帧时间',
        ...
        jsonTemplate: 'JSON 模版',
        insertPlaceholder: '插入占位符',
        jsonTemplateHint: '支持占位符 ${DATA} ${TIMESTAMP} ${DEVICE_SN}',
        invalidJsonTemplate: 'JSON 格式错误',
        pleaseInputRuleName: '请输入规则名称',
        modbusConflict: '已被 Modbus 采集占用',
        topicConflictWarn: '与数据上报主题重复，请确认',
