...
export default {
    ...
    dtu: {
        title: '数传',
        description: '串口数据透传到 Socket / HTTP / MQTT。各串口可独立选择数传或边缘计算。',
        enable: '数传使能',
        workMode: '工作模式',
        modeNet: '网络透传 (NET)',
        modeHttp: 'HTTP 透传',
        ...
        sockBind: '绑定 Socket',
        mqttBind: '绑定 MQTT',
        sockHint: '固定使用本串口对应 Socket 通道，连接参数请在「通信 → Socket」中配置（可为 Client 或 Server）。',
        httpHint: '请将本串口对应 Socket 工作模式设为 HTTP Client，详细参数在 Socket 页配置。',
        mqttConnHint: '固定使用本串口对应 MQTT 通道；Broker/鉴权/SSL 请在「通信 → MQTT」中配置，透传主题在本页配置。',
        fixedChannelUart1: '本通道固定对应 SOCKA / MQTT1。',
        fixedChannelUart2: '本通道固定对应 SOCKB / MQTT2。',
        pubTopic: '发布主题',
        prefixEnable: '下行格式化',
        prefixOn: '主题,数据',
        prefixOff: '仅数据(透传)',
